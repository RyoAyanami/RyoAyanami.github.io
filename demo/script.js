document.addEventListener("DOMContentLoaded", () => {
    ...
    let questions = [
        { text: "你最喜欢的机体是？", options: ["二号机 红色与力量感", "零号机 蓝色与冷静", "初号机 紫色与神秘", "Mark.06 蓝色与优雅", "八号机 粉色与独特"], characters: ["明日香", "绫波丽", "碇真嗣", "渚薰", "真希波"], bg: "1.jpg" },
        ...
        { text: "你如何看待“孤独”？", options: ["孤独是弱者的借口", "孤独是常态，无需改变", "孤独让我痛苦，但无法摆脱", "孤独是创作的灵感来源", "孤独是理解他人的起点"], characters: ["明日香", "绫波丽", "碇真嗣", "真希波", "渚薰"], bg: "5.jpg" },
        { text: "如果和使徒作战，你会选择的进攻方式是？", options: ["高速突进，近战压制", "冷静分析，以静制动", "被动防御，等待反击", "灵活游击，远程轰炸", "优雅舞动，以柔克刚"], characters: ["明日香", "绫波丽", "碇真嗣", "真希波", "渚薰"], bg: "6.jpg" },
        { text: "你最喜欢的场景色调？", options: ["红色，充满激情", "蓝色，冷静而深邃", "紫色，神秘且压抑", "粉色，活泼又独特", "白色，纯净而优雅"], characters: ["明日香", "绫波丽", "碇真嗣", "真希波", "渚薰"], bg: "7.jpg" }
    ];
