document.addEventListener("DOMContentLoaded", () => {
    ...
    let questions = [
        ...
        { text: "你最喜欢的名台词是？", options: ["微笑就可以了", "如果你不能完全成为我的", "早安晚安谢谢再见", "保重啊公主殿下", "也许我就是为了与你相遇才出生的"], characters: ["碇真嗣", "明日香", "绫波丽", "真希波", "渚薰"], bg: "4.jpg" },
    ...
    function displayResult(character) {
        ...
        let descriptions = {
            ...
            "真希波": "你你像真希波一样，活泼而乐观，总是以独特的视角看待世界。你的笑容是战场上的光芒，而你的选择，或许正是为了守护这份美好。快乐不仅是权利，更是责任。",
